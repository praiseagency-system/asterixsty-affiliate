      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-3">
            ...
            <button
              onClick={handleRun}
              disabled={running || !sessions.some((s) => s.status === "CONNECTED")}
            ...
            {!sessions.some((s) => s.status === "CONNECTED") && (
              <p className="text-xs text-gray-400 text-center">Hubungkan minimal satu akun WhatsApp di atas untuk mengirim reminder.</p>
            )}
