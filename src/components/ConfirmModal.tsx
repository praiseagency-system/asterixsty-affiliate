...
export default function ConfirmModal({
  ...
  return (
    <>
      {/* Backdrop */}
      <div className="fixed inset-0 bg-black/40 z-50 backdrop-blur-[2px]" onClick={onCancel} />

      {/* Modal */}
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md pointer-events-auto overflow-hidden">
          {/* Header */}
          <div className={`px-6 pt-6 pb-4 ${danger ? "border-b border-red-50" : "border-b border-gray-100"}`}>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center mb-3 ${danger ? "bg-red-100" : "bg-indigo-100"}`}>
